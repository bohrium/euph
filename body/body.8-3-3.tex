  ...
  \fig{figs/fig-7a721610.png}{Figure 1. Bifurcation diagram for Duffing's 
  equation} 
  ...
  \fig{figs/fig-38fae99a.png}{Figure 2. Potential energy $V(x)$ for the Duffing 
  equation, for the case $\mu =1$. The upper curve (yellow) corresponds to 
  $\alpha = 1$, the middle curve (red) to $\alpha = 0.1$, the lower curve 
  (blue) to $\alpha = -1$.} 