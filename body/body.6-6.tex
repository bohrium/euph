  ...
  \aud{auds/aud-ab40b485-plot.png}{\caption{Sound 1. Synthesised music based on 
  the guitar with Indian rosewood back and sides.}} 

  \aud{auds/aud-46ab9b36-plot.png}{\caption{Sound 2. Synthesised music based on 
  the guitar with Sapele back and sides.}} 

  \aud{auds/aud-b41c465e-plot.png}{\caption{Sound 3. Synthesised music based on 
  an entirely different guitar, not part of the set of six. Its bridge 
  admittance was shown in the blue curve of Fig. 3.}} 
