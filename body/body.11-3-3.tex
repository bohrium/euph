  ...
  \fig{figs/fig-9685d652.png}{\caption{Figure 1. Sketch of the geometry of the 
  truncated cone.}} 
  ...
  \noindent{}with a cutoff frequency $\omega_c$ chosen suitably: for the 
  saxophone model discussed here this cutoff was placed at 1~kHz. 
  ...
  \fig{figs/fig-12d3ef54.png}{\caption{Figure 2. The input impedance used for 
  the simulations: the red curve is for the truncated cone only, the blue one 
  ...
  \fig{figs/fig-17c5a631.png}{\caption{Figure 3. A measured input impedance of 
  the lowest note of a soprano saxophone, taken from 
  https://newt.phys.unsw.edu.au/music/saxophone/soprano/Asharp3.html and 
  reproduced by permission of Joe Wolfe. Note that the $B\flat$ saxophone is a 
  transposing instrument, so the note written as $B\flat$ plays at pitch 
  $A\flat$.}} 
  ...
  \fig{figs/fig-841bc722.png}{\caption{Figure 4. The input impedances from Fig. 
  2, with the addition of the result for the ``cylindrical saxophone'' model 
  (green curve).}} 
  ...
  \fig{figs/fig-453e1716.png}{\caption{Figure 5. Impulse responses deduced from 
  the input impedances of Fig. 2: the red curve without the mouthpiece, the 
  blue curve including the mouthpiece.}} 

  \fig{figs/fig-3989fd7f.png}{\caption{Figure 6. Reflection functions deduced 
  from the input impedances of Fig. 2: the red curve without the mouthpiece, 
  the blue curve including the mouthpiece.}} 
