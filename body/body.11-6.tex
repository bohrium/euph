  ...
  \fig{figs/fig-e0eed9ea.png}{} 

  \fig{figs/fig-61049be2.png}{} 

  \fig{figs/fig-de78f4f6.png}{} 

  \fig{figs/fig-858f3bf4.png}{} 
  ...
  \fig{figs/fig-c0bc0425.png}{\caption{Figure 2. A Wheatstone English button 
  concertina disassembled to show the bellows, reedpan and buttons. Image 
  uploaded by Neil McDermott to English Wikipedia, CC BY-SA 3.0 
  ...
  \fig{figs/fig-eb253c51.png}{\caption{Figure 3. Sketch of the two reed 
  configurations: a ``closing reed'' on the left, and an ``opening reed'' on 
  the right.}} 
  ...
  \fig{figs/fig-81b6fb96.png}{\caption{Figure 4. Fletcher's model of a reed 
  attached to a closed volume of air, driven by a steady air flow. This sketch 
  shows an ``opening reed'' configuration, but the reed could equally well be 
  attached to the inside of the chamber wall to give a ``closing reed''.}} 
  ...
  \fig{figs/fig-fb72c86b.png}{\caption{Figure 5. Sketch showing a reed 
  vibrating vigorously, so that it passes all the way through the plate.}} 
  ...
  \fig{figs/fig-835ab317.png}{\caption{Figure 6. Plot of the area available for 
  air flow past a reed as a function of the tip displacement, for an opening 
  reed (red) and a closing reed (blue). This example is for a harmonica reed of 
  length 14.5~mm and width 2~mm, stood off from a plate of thickness 0.8~mm by 
  a distance 0.5~mm. The clearance between reed and slot is 0.2~mm all round.}} 
  ...
  \fig{figs/fig-da259f84.png}{\caption{Figure 7. Predicted threshold pressure 
  according to Fletcher's theory, compared to measurements replotted from Fig. 
  2 of Tarnopolsky, Fletcher and Lai [1]. Colours indicate the Q-factor of the 
  reed: 16 (red), 19 (blue), 29 (green) and 55 (black). Note that their 
  original plot contains an error: the labels for Q-factors were in the reverse 
  order.}} 
  ...
  \fig{figs/fig-67af104a.png}{\caption{Figure 8. A modified version of Fig. 4, 
  suggested by Millot [3]. A tube has been added between the chamber and the 
  reed.}} 
  ...
  \fig{figs/fig-8836c11a.png}{\caption{Figure 9. Plot of the area available for 
  air flow past a reed as a function of the tip displacement in the same format 
  as Fig. 6, for an opening reed (red) and a closing reed (blue). This example 
  is for the reed geometry relevant to the experiment of Tarnopolsky, Fletcher 
  and Lai [1]: length 28~mm and width 52~mm, stood off from the base plate by a 
  ...
  \fig{figs/fig-7ec0c143.png}{\caption{Figure 10. Predicted pressure thresholds 
  in a similar format to Fig. 7, but plotted over different ranges. The solid 
  lines relate to the opening-reed configuration, the dash-dot lines to the 
  ...
  \fig{figs/fig-9c047aef.png}{\caption{Figure 11. Predicted pressure thresholds 
  in the same format as Fig. 10, but with the values for the ratio of reed 
  resonance frequency to Helmholtz resonance frequency now greater than unity. 
  Here the ratios are 1.05 (red), 1.2 (blue), 1.5 (green) and 2 (black).}} 
  ...
  \fig{figs/fig-7fae24a7.png}{\caption{Figure 12. A set of synthesised results 
  for a harmonica reed with properties as listed in the caption of Fig. 6, 
  tuned to 440 Hz. The ratio of reed resonance frequency to Helmholtz frequency 
  has been set to 1.5, so the reed plays in the closing-reed configuration as 
  usual in a harmonica. The colour shading indicates the spectral centroid 
  frequency. The blue line marks the threshold of instability according to 
  Fletcher's analysis.}} 

  \fig{figs/fig-c2f98da6.png}{\caption{Figure 13. The same set of synthesised 
  results as in Fig. 12, now colour-shaded to indicate the peak-to-peak 
  amplitude of the internal pressure waveform in the final periodic portion of 
  each note.}} 
  ...
  \fig{figs/fig-f88e514f.png}{\caption{Figure 14. Simulated waveforms of 
  internal pressure for the same reed model as in Figs. 12 and 13. This plot 
  shows extracts from the final periodic waveform. The five cases correspond to 
  the five pixels marked with a green rectangle in Figs. 12 and 13, with the 
  case with the lowest cavity volume at the top.}} 

  \aud{auds/aud-6b903a18-plot.png}{\caption{Sound 1. Synthesised transient 
  sounds, for the five cases marked in Figs. 12 and 13 and shown in Fig. 14.}} 
  ...
  \fig{figs/fig-2ffac854.png}{\caption{Figure 15. Detailed waveforms for the 
  simulation shown in the top curve of Fig. 14. Top: reed tip displacement, 
  with dashed lines indicating the position of the reed plate; middle: the 
  pressure waveform as in Fig. 14; bottom: the air-flow rate around the reed.}} 
  ...
  \fig{figs/fig-edd863d0.png}{\caption{Figure 16. Simulated initial transient 
  of a harmonica reed, corresponding to the second pixel from the left in the 
  set marked in Figs. 12 and 13, and to the final periodic waveform plotted in 
  blue in Fig. 14.}} 
  ...
  \fig{figs/fig-6e7d7b84.png}{\caption{Figure 17. Schematic sketch of a 
  harmonica reed channel with its two reeds, and the attached mouth cavity of 
  the player.}} 
  ...
  \aud{auds/aud-000f52b0-plot.png}{\caption{Sound 2. The sound of the internal 
  pressure waveform of a synthesised harmonica ``bend'' using Millot's model 
  with a mouth pressure of 2~kPa, when the Helmholtz resonance frequency of the 
  mouth cavity moves linearly upwards from 400~Hz to 440~Hz.}} 
  ...
  \fig{figs/fig-ac94777d.png}{\caption{Figure 18. A portion of the spectrogram 
  of Sound 2, showing harmonics 5, 6 and 7 of the synthesised harmonica 
  pressure waveform. It can be seen that the frequency moves downwards slowly 
  at first, then more rapidly, then finally settles into a steady pattern at a 
  lower frequency.}} 
  ...
  \fig{figs/fig-bd9ffb21.png}{\caption{Figure 19. Tip displacements of the two 
  reeds in the synthesis of Sound 2. The result for the opening reed, in red, 
  has been shifted down by 10~mm for clarity.}} 

  \fig{figs/fig-ae4b6fe1.png}{\caption{Figure 20. The tip displacement of reed 
  1 as a fraction of the RMS displacement of the two reeds, showing the 
  transition during the course of the ``bend''.}} 
  ...
  \fig{figs/fig-803c1aa3.png}{\caption{Figure 21. The mouth cavity volume 
  (expressed in cubic centimetres, or ml) needed to produce the range of 
  Helmholtz resonance frequencies in the Sound 2 synthesis.}} 
  ...
  \fig{figs/fig-5dd5ce88.png}{\caption{Figure 22. Map of the normalised playing 
  ...
  \fig{figs/fig-96eb5429.png}{\caption{Figure 23 Map corresponding to Fig. 22, 
  for the converse case when the reed at lower frequency is an opening reed, 
  while the one at higher frequency is a closing reed. The comparison of the 
  two figures would correspond to blowing and drawing on the same hole in the 
  harmonica. Frequency is normalised by the free resonance frequency of the 
  higher reed, 440~Hz.}} 
  ...
  \fig{figs/fig-af4fce61.png}{} 

  \fig{figs/fig-e6a2da9c.png}{} 
  ...
  \fig{figs/fig-da7d6e66.png}{} 

  \fig{figs/fig-d704aa02.png}{} 
