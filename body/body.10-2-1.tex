  ...
  \fig{figs/fig-af12f4b8.png}{\caption{Figure 1. Specimen of Norway spruce, cut 
  to reveal the LR plane (top half) and the RT plane (bottom half).}} 
  ...
  \fig{figs/fig-1b160d61.png}{\caption{Figure 2. A group of bordered pits in 
  Norway spruce}} 

  \fig{figs/fig-45252b64.png}{\caption{Figure 3. A bordered pit that has lost 
  its top half, so that the membrane forming a flap valve is visible}} 

  \fig{figs/fig-0f02f769.png}{\caption{Figure 4. A bordered pit in a different 
  species of softwood, in which the valve has remained open rather than sealing 
  shut}} 
  ...
  \fig{figs/fig-863a0b66.png}{\caption{Figure 5. Typical view of a cut in the 
  RT plane in Norway spruce.}} 
  ...
  \fig{figs/fig-40a1f9a5.png}{\caption{Figure 6. Close-up of a similar cut to 
  Fig. 5.}} 
  ...
  \fig{figs/fig-47eb4d43.png}{\caption{Figure 7. Norway spruce, cut 
  approximately in the LR plane.}} 

  \fig{figs/fig-28b0e33a.png}{\caption{Figure 8. Norway spruce, cut in the LT 
  plane}} 
  ...
  \fig{figs/fig-31abaa71.png}{\caption{Figure 9. Typical structure of 
  violin-quality maple Acer platanoides.}} 

  \fig{figs/fig-b81dd986.png}{\caption{Figure 10. Closer view of maple, as in 
  Fig. 6.}} 
  ...
  \fig{figs/fig-14411e2b.png}{\caption{Figure 11. A sample of Norway spruce 
  that has been clamped too hard in a vice, causing a line of cells to 
  collapse.}} 
  ...
  \fig{figs/fig-1d303b74.png}{\caption{Figure 12. A sample of Norway spruce, 
  showing LR and RT planes as in Fig. 1. The top surface was prepared using a 
  heavy cabinet scraper, and this has collapsed the thin-walled tracheids in 
  the top two layers or so.}} 

  \fig{figs/fig-0f65af8b.png}{\caption{Figure 13. A similar Norway spruce 
  sample to the one in Fig. 12, but this has been moistened to ``raise the 
  grain''. The collapsed cells have recovered their shape, making a step on the 
  top surface at the boundary of the annual ring.}} 
  ...
  \fig{figs/fig-912779cc.png}{\caption{Figure 14. The LR surface of a Norway 
  spruce sample which has been prepared with fine-grit abrasive paper.}} 

  \fig{figs/fig-d2a182a0.png}{\caption{Figure 15. The LR surface of a Norway 
  spruce sample which has been prepared by rubbing with dogfish skin, a natural 
  ``abrasive''.}} 
  ...
  \fig{figs/fig-a18421c1.png}{\caption{Figure 16. The surface of a new sample 
  of dogfish skin, showing the ``denticles''.}} 

  \fig{figs/fig-773e0e9f.png}{\caption{Figure 17. The surface of dogfish skin 
  which has been used to smooth wood, wearing the denticles down.}} 