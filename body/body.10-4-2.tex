  ...
  \fig{figs/fig-3b7db1e7.png}{Figure 1. An illustration of aliasing. A sine 
  wave at frequency 4.5~kHz is shown in black. The red stars are the result of 
  sampling this sine wave at a frequency of 5~kHz. They dot out a sine wave 
  with the much lower frequency 500~Hz, which is 5000-4500~Hz: the sampling 
  frequency minus the sine wave frequency.} 
  ...
  \fig{figs/fig-627f0190.png}{Figure 2. The response from an accelerometer 
  attached to the bridge of a banjo, following a hammer tap.} 
  ...
  \samsection{C: What could possibly go wrong?} 
  ...
  \fig{figs/fig-c7af4f8c.png}{Figure 3. A treble viol being tested. Note the 
  holding arrangement and the card for string damping} 
  ...
  \fig{figs/fig-1dad2cd1.png}{Figure 4. Measured bridge admittance of a violin, 
  with strings damped (blue) and undamped (red)} 
  ...
  \fig{figs/fig-f0939372.png}{Figure 5. The bridge admittance of a violin 
  (blue) with the associated coherence function (red)} 
