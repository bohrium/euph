...
\moobeginvid\begin{tabular}{ccc} \vidframe{ 0.30 }{ vids/vid-69279fd5-00.png }&\vidframe{ 0.30 }{ vids/vid-69279fd5-01.png }&\vidframe{ 0.30 }{ vids/vid-69279fd5-02.png } \end{tabular}\caption{Figure 1. The ``Helmholtz motion'' of a bowed string. The upper plot shows the string motion (with an exaggerated vertical scale), the lower plot shows the corresponding waveform of force exerted on the violin bridge, which excites body vibration and creates the sound of the instrument.}\mooendvideo
  ...
  \fig{figs/fig-fc61a10c.png}{\caption{Figure 2. A simulated example of 
  Helmholtz motion in a bowed string. The upper plot shows the bridge force, as 
  in the lower part of Fig. 1. The lower plot shows the waveform of string 
  velocity at the bowed point.}} 
  ...
  \fig{figs/fig-2522e306.png}{\caption{Figure 3. Schelleng's diagram, 
  reproduced from Fig. 1 of section 9.3. In order to sustain a steady Helmholtz 
  motion, a violinist must control their bow force and bow position so as to 
  lie within the wedge-shaped region between the two red lines.}} 
