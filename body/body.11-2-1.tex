  ...
  \fig{figs/fig-30d0c10a.png}{Figure 1. A small element of volume} 
  ...
  \fig{figs/fig-0eeccaa5.png}{Figure 2. Flow over a fixed surface, with a 
  boundary layer profile. A material element in the boundary layer, shown in 
  dark blue, experiences differential flow speed and hence has net rotation.} 
  ...
  \fig{figs/fig-f78b9c18.png}{Figure 3. Sketch of flow round an airfoil 
  immediately after motion has started.} 
  ...
  \fig{figs/fig-aa65cca0.png}{Figure 4. The airfoil as in Fig. 3, forming a 
  ``separation bubble'' near the trailing edge.} 
  ...
  \fig{figs/fig-cd4b7009.png}{Figure 5. The airfoil as in Figs. 3 and 4, after 
  a vortex has been shed and left behind. The flow near the trailing edge is 
  now smooth, the there is net circulation round the wing as indicated by the 
  red arrow.} 
