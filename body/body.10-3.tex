  ...
  \fig{figs/fig-6259a487.png}{\caption{Figure 1. Sketch of a spruce billet for 
  a violin top plate, being floated in water to find its density.}} 
  ...
  \fig{figs/fig-63aff26c.png}{\caption{Figure 2. The three principal directions 
  L, R and T in a tree. The left-hand black outline indicates the way that a 
  radial wedge would be cut for a violin soundboard. The right-hand one shows 
  how a constant-thickness board for a guitar soundboard might be sawn: such a 
  board might be close to radial, but more often it might deviate from that 
  ideal condition like the example shown here.}} 
  ...
  \fig{figs/fig-065f8724.png}{\caption{Figure 3. Rectangular beams cut from the 
  offcut spruce of six different violin top plates. They are aligned in the 
...
\moobeginvid\begin{tabular}{ccc} \vidframe{ 0.30 }{ vids/vid-4b909508-00.png }&\vidframe{ 0.30 }{ vids/vid-4b909508-01.png }&\vidframe{ 0.30 }{ vids/vid-4b909508-02.png } \end{tabular}\caption{Figure 7. A vibration mode of a rectangular plate with free edges, this time dominated by twist. This mode  often has the lowest frequency of the three shown here.}\mooendvideo
  ...
  \fig{figs/fig-fbe59ba8.png}{\caption{Figure 8. The three important 
  stiffnesses of a flat plate, cut from solid spruce with a range of ring 
  angles. The red line shows the long-grain stiffness, the blue line shows the 
  cross-grain stiffness, and the black line shows the twisting stiffness.}} 
  ...
  \fig{figs/fig-bfa05589.png}{\caption{Figure 9. A piece of Norway spruce 
  supplied for a guitar soundboard. Notice that the annual rings go through the 
  thickness at an angle close to $45^\circ$. This results in very low 
  ...
  \fig{figs/fig-dac41904.png}{\caption{Figure 10. SEM image of the cell 
  structure of spruce, showing a section in the RT plane, the ``end grain''. 
  This is a copy of Fig. 2 from section 10.2.}} 
  ...
  \fig{figs/fig-5054f264.png}{\caption{Figure 11. Still from a video animating 
  the result of a high resolution CT scan of a Stradivari violin. This is a 
  ...
  \fig{figs/fig-0999b7de.png}{\caption{Figure 12. Sketch of a vibrating beam 
  held in a clamp. When the beam bends, a small amount of sideways slipping 
  occurs near the corners of the clamp, so that energy is dissipated via 
  friction.}} 
