  ...
  \fig{figs/fig-5d96bc34.png}{\caption{Figure 1. A segment of bending beam, and 
  a small element extracted from it with the shear forces and bending moments 
  indicated. The vertical scale is exaggerated.}} 
  ...
  \begin{equation*}M(x,t) = EI\dfrac{\partial^2 w}{\partial x^2} . 
  \tag{5}\end{equation*} 
  ...
  \begin{equation*}u=C_1 e^{ikx} + C_2 e^{-ikx} + C_3 e^{kx} + C_4 e^{-kx} 
  \tag{11}\end{equation*} 
  ...
  \begin{equation*}(\cosh kL -\cos kL)^2 = (\sinh kL + \sin kL)(\sinh kL -- 
  ...
  \fig{figs/fig-65ab5053.png}{\caption{Figure 2. Plots of $\cos kL$ (in red) 
  and $1/\cosh kl$ (in blue). The intersections, shown ringed, give the 
  solutions of eq. (17)}} 