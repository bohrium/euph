  ...
  \fig{figs/fig-71d73b4c.png}{Figure 1. Sketch showing an impact between a 
  ``striker'' (circle) and an ``instrument'' (rectangle), through a contact 
  spring that might be either linear or Hertzian.} 
