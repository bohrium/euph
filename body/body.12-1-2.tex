  ...
  \fig{figs/fig-524f36e4.png}{Figure 1. Sketch of a mass approaching and then 
  bouncing off a system that can vibrate.} 
  ...
  \fig{figs/fig-3d62b640.png}{Figure 2. The idealised force pulse when a mass 
  bounces off a rigid surface, mediated by a linear contact spring.} 
  ...
  \fig{figs/fig-0898e2c2.png}{Figure 4. The threshold contact resonance 
  frequency for which $K^\prime = 1$, as a function of hammer mass, when 
  striking the same plate as used in Fig. 3. Logarithmic scales are used on 
  both axes.} 

  \fig{figs/fig-442ccb6e.png}{Figure 5. The threshold contact duration in ms 
  for which $K^\prime = 1$ expressed as a function of hammer mass, using the 
  same data as for Fig. 4. Logarithmic scales are used on both axes.} 
