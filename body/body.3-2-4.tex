  ...
  \fig{figs/fig-3d9226ce.png}{Figure 1. Modes of a rectangular plate of 
  dimensions $0.6 \times 0.4$ m, plotted in wavenumber space (red stars). The 
  blue curve encloses the set of modes with natural frequencies below a chosen 
  frequency.} 
