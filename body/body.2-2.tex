  ...
  \fig{figs/fig-d2971ee6.png}{\caption{<br>Figure 1: A sawtooth wave being 
  built up by adding sine waves. Left column: the successive sine waves; right 
  column: the cumulative waveform at each stage. Only the first six terms are 
  shown, but the process could continue indefinitely, making the waveform 
...
\audio{}
  ...
  \fig{figs/fig-6adeb7ce.png}{\caption{<br>Figure 3: The vibration modes of an 
