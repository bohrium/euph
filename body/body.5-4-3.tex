  ...
  \fig{figs/fig-5616e0f4.png}{\caption{Figure 1. A small element of deflected 
  string (exaggerated vertical scale).}} 
  ...
  \begin{equation*}V=\frac{1}{2}\int_0^L{P \left(\frac{\partial w}{\partial 
