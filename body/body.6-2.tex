  ...
  \fig{figs/fig-8d65f9a1.png}{\caption{Figure 1. Diagram of the components of a 
  human ear. Image: Inductiveload, CC BY-SA 2.5 
  ...
  \fig{figs/fig-c6d34c52.png}{\caption{Figure 2. Diagram similar to Fig. 1, but 
  showing the cochlea unrolled to reveal the pattern of peak frequency response 
  along the length of the basilar membrane. Image: Kern A, Heid C, Steeb W-H, 
  Stoop N, Stoop R, CC BY 2.5 https://creativecommons.org/licenses/by/2.5, via 
  Wikimedia Commons}} 
  ...
  \fig{figs/fig-bf0861ce.png}{\caption{Figure 3. A schematic diagram of a sound 
  wave passing the head of a listener}} 
