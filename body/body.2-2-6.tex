  ...
  \fig{figs/fig-47b667ec.png}{Figure 1. The bounce of an idealised hammer} 
  ...
  \fig{figs/fig-703fc628.png}{Figure 2: Frequency spectrum of an ideal hammer 
  tap} 
  ...
  \fig{figs/fig-72baa61b.png}{Figure 3: Two versions of the frequency spectrum 
  from Fig.2, now plotted against a frequency scale in Hz for two different 
  values of the frequency $\Omega$: expressed in Hz, the red curve corresponds 
  to 300 Hz and the black curve to 1500 Hz.} 