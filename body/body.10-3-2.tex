  ...
  \fig{figs/fig-dc1da399.png}{Figure 1. A ``shaker table'' being used to 
  generate a Chladni pattern on a plywood plate.} 
  ...
  \fig{figs/fig-7c4f3b78.png}{Figure 2. Chladni pattern of another mode of the 
  plate seen in Fig. 1.} 
  ...
  \fig{figs/fig-1a380290.png}{Figure 3. Predicted nodal line patterns of a few 
  modes of a rectangular orthotropic plate with particular values of the plate 
  stiffnesses. The frequencies of these modes do not necessarily appear in the 
  order shown, though: that depends on the values of the stiffnesses we are 
  trying to measure. The exact shape of the nodal lines also varies with those 
  stiffnesses, but you can usually find modes looking recognisably like these 
  patterns.} 
  ...
  \fig{figs/fig-b5a5a281.png}{Figure 4. The lowest mode of a particular spruce 
  plate. This is a twisting mode.} 

  \fig{figs/fig-afe8bd60.png}{Figure 5. The second mode of the spruce plate 
  from Fig. 4, involving predominantly bending across the grain.} 

  \fig{figs/fig-84143751.png}{Figure 6. The 5th mode of the spruce plate from 
  Figs. 4 and 5, involving predominantly bending along the grain.} 
  ...
  \fig{figs/fig-906d6135.png}{Figure 7. Predicted nodal line patterns of two 
  modes of a square isotropic plate. For obvious reasons, these are usually 
  called the ``X-mode'' and the ``ring mode''.} 

  \fig{figs/fig-1b23e951.png}{Figure 8. The two modes from Fig. 7, shown in a 
  3D view.} 
