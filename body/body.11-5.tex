  ...
  \aud{auds/aud-e721a385-plot.png}{\caption{Sound 1. The four synthesised 
  sounds marked by circles in Fig. 16, and whose last few cycles were plotted 
  in Fig. 15.}} 
  ...
  Increasing the delay seems to help with producing the lower notes, but makes 
  ...
  The physics-based concern arises directly from the very high damping of the 
  ...
  The second concern to be aired about the lip model is quite different. When 
  ...
  But in the computer model, all the parameters can be specified independently. 
  ...
  \fig{figs/fig-470ea0f3.png}{\caption{Figure 41. A particular set of simulated 
  waveforms, compared with corresponding waveforms measured by Boutin et al. 
  [6] for their case in which the note was “lipped up”. All simulated waveforms 
  are shown as solid lines, while measured ones are shown as dashed lines in 
  the corresponding colour. The top plot shows the comparison for the pressure 
  inside the mouthpiece. The middle plot shows the total volume flow rate 
  (blue) and the sweeping flow contribution to that (green). The bottom plot 
  shows the lip opening area. Using notation defined in section 11.5.3, the 
  parameter values are: $Q\_r=5$, $\alpha=2$, $\lambda=0$, $H\_0=0.5 
  \mathrm{~mm}$, $L\_{lip}=8 \mathrm{~mm}$, blowing pressure 1~kPa, lip 
  resonance frequency 113~Hz, delay 1.5~ms.}} 

  \fig{figs/fig-f1197a4e.png}{\caption{Figure 42. A different set of simulated 
  waveform from the ones in Fig. 41, compared in the same format with 
  corresponding waveforms measured by Boutin et al. [6] for their case in which 
  the note was “lipped up”. All simulated waveforms are shown as solid lines, 
  while measured ones are shown as dashed lines in the corresponding colour. 
  The top plot shows the comparison for the pressure inside the mouthpiece. The 
  middle plot shows the total volume flow rate (blue) and the sweeping flow 
  contribution to that (green). The bottom plot shows the lip opening area. 
  Using notation defined in section 11.5.3, the parameter values are: $Q\_r=1$, 
  $\alpha=0.5$, $\lambda=2$, $H\_0=0$, $L\_{lip}=25 \mathrm{~mm}$, blowing 
  pressure 1~kPa, lip resonance frequency 97~Hz, delay 1.5~ms.}} 
