  ...
  \fig{figs/fig-bb3b52cf.png}{\caption{Figure 1. Schelleng's diagram}} 
  ...
  \fig{figs/fig-a72af2af.png}{\caption{Figure 2. Schelleng's diagram as in Fig. 
  1, illustrating what happens if the bow position varies while the bow force 
  ...
  \fig{figs/fig-68ec83c4.png}{\caption{Figure 3. Three alternative positions 
  for the minimum bow force line in Schelleng's diagram.}} 
  ...
  \fig{figs/fig-3b8a22fe.png}{\caption{Figure 4. A measured version of 
  Schelleng's diagram. The colour code shows red for Helmholtz motion, orange 
  for double-slipping, yellow for decaying motion, black for non-periodic 
  raucous motion and white for S-motion. Blue arrows mark columns shown in 
  detail in Fig. 4. Green arrows mark columns investigated in Figs. 5--8.}} 
  ...
  \fig{figs/fig-2090123e.png}{\caption{Figure 5. Extracts of waveforms from 
  four of the columns of Fig. 4, indicated there by the blue arrows.}} 
  ...
  \fig{figs/fig-77280e7e.png}{\caption{Figure 6. Spectrum amplitude as a 
  function of harmonic number, for cases of Helmholtz motion in column 6 of 
  Fig. 4, marked with a green arrow. The colours of the plotted lines shade 
  progressively from red to blue to green, as the cases move upwards along this 
  column. The vertical dashed line marks the expected frequency of Schelleng's 
  ripples, at harmonic numbers close to $1/\beta$.}} 
  ...
  \fig{figs/fig-59275fef.png}{\caption{Figure 7. Spectrum plot in the same 
  format as Fig. 6, for column 11 of Fig. 4.}} 

  \fig{figs/fig-99e8ecc3.png}{\caption{Figure 8. Spectrum plot in the same 
  format as Fig. 6, for column 16 of Fig. 4.}} 
  ...
  \fig{figs/fig-a72a62a2.png}{\caption{Figure 9. Pitch flattening, expressed in 
  cents, for the Helmholtz motion cases in column 11 of Fig. 4 (the same set 
  that gave the spectra shown in Fig. 7).}} 
