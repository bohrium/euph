  ...
  \fig{figs/fig-8b3d92ae.png}{\caption{Figure 1. A small element of a 
  one-dimensional sound wave, showing particle displacements.}} 
  ...
  \begin{equation*}p V^\gamma = \mathrm{constant} \tag{3}\end{equation*} 
  ...
  \begin{equation*}\frac{\partial^2 p'}{\partial x^2} = -\rho_0 
