  ...
  \aud{auds/aud-3d579d6a-plot.png}{\caption{Sound 1. A sequence of string-like 
  sounds with increasing inharmonicity from bending stiffness, alternating 
  between perfectly harmonic sounds.}} 
  ...
  \aud{auds/aud-124785d2-plot.png}{\caption{Sound 2. All frequencies reduced by 
  6\%}} 

  \aud{auds/aud-353df898-plot.png}{\caption{Sound 3. Reference case}} 

  \aud{auds/aud-3bb966e2-plot.png}{\caption{Sound 4. All frequencies increased 
  by 6\%}} 
  ...
  \aud{auds/aud-8efa54eb-plot.png}{\caption{Sound 5. All Q factors halved}} 

  \aud{auds/aud-2953e8c1-plot.png}{\caption{Sound 6. Reference case}} 

  \aud{auds/aud-499295af-plot.png}{\caption{Sound 7. All Q factors doubled}} 

  \aud{auds/aud-5711a4e5-plot.png}{\caption{Sound 8. All Q factors quadrupled}} 
  ...
  \fig{figs/fig-009bf48a.png}{\caption{Figure 1. A violin bridge equipped with 
  a force-measuring sensor under each string, to use in the ``virtual violiin'' 
  experiment.}} 
  ...
  \aud{auds/aud-e30589e9-plot.png}{\caption{Sound 9. A snatch of violin playing 
  as recorded using the bridge-force sensors shown in Fig. 1. This particular 
  passage is played entirely on the G string.}} 
  ...
  \aud{auds/aud-c38ab7cd-plot.png}{\caption{Sound 10. The force signal from 
  Sound 9, processed with the response of a violin.}} 

  \aud{auds/aud-a7f88816-plot.png}{\caption{Sound 11. The force signal from 
  Sound 9, processed with the response of a second violin.}} 

  \aud{auds/aud-6d52dee8-plot.png}{\caption{Sound 12. The force signal from 
  Sound 9, processed with the response of a third violin.}} 
  ...
  \aud{auds/aud-45251347-plot.png}{\caption{Sound 13. A short extract from the 
  ``music'' of Sound 9, convolved with the response of a violin used as the 
  datum case for the threshold tests.}} 

  \aud{auds/aud-a25dd8f5-plot.png}{\caption{Sound 14. As Sound 13, but with all 
  body frequencies raised by 1\%.}} 

  \aud{auds/aud-d623b1a8-plot.png}{\caption{Sound 15. As Sound 13, but with all 
  body frequencies raised by 5\%.}} 

  \aud{auds/aud-acc8ea47-plot.png}{\caption{Sound 16. As Sound 13, but with all 
  body frequencies raised by 10\%.}} 
