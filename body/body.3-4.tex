  ...
  \aud{auds/aud-a101110c-plot.png}{\caption{Sound 1. A short snatch of change 
  ringing.}} 
  ...
  \aud{auds/aud-b83a451f-plot.png}{\caption{Sound 2. A single note of the 
  ``bell'' corresponding to the red curve in Fig. 5.}} 

  \aud{auds/aud-267cd96e-plot.png}{\caption{Sound 3. A single note of the 
  true-harmonic ``bell'' corresponding to the black curve in Fig. 5.}} 

  \aud{auds/aud-27609b3d-plot.png}{\caption{Sound 4. A few notes, based on the 
  bell from Sound 2.}} 

  \aud{auds/aud-c6e9f22e-plot.png}{\caption{Sound 5. The same few notes, based 
  on the bell from Sound 3.}} 
