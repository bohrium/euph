  ...
  \fig{figs/fig-bc47e78a.png}{\caption{Figure 1: Sketch of the force applied 
  when a drum is struck (upper trace) and the resulting motion of the drum skin 
  (lower trace).}} 

  \fig{figs/fig-bd8fc8a5.png}{\caption{Figure 2: Schematic block diagram of the 
  drum as an input-output ``black box''.}} 
  ...
  \fig{figs/fig-63a34022.png}{\caption{Figure 3: Portions of two sine waves 
  with the same frequency: the solid curve could be the input to a linear 
  system, and the dashed curve the corresponding output. The sine wave shown in 
  the dashed curve has a larger \textbf{amplitude} than the one shown solid, 
  and its \textbf{phase} is shifted as indicated.}} 
