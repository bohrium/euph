  ...
  \fig{figs/fig-bc47e78a.png}{Figure 1: Sketch of the force applied when a drum 
  is struck (upper trace) and the resulting motion of the drum skin (lower 
  trace).} 

  \fig{figs/fig-bd8fc8a5.png}{Figure 2: Schematic block diagram of the drum as 
  an input-output ``black box''.} 
