  ...
  \fig{figs/fig-788631bb.png}{Figure 1. Repeat of Fig. 7 for section 9.2, 
  showing the graphical construction involving the intersection of a straight 
  line and the friction force-velocity curve. Three examples of possible 
  positions of the straight line are shown in blue, and two versions of the 
  force-velocity curve (corresponding to different bow forces) are shown in 
  red.} 
  ...
  \fig{figs/fig-eea24b1c.png}{Figure 2. Repeat of Fig. 8 of section 9.2, 
  illustrating the hysteresis loop and jump behaviour that arises if the 
  ...
  \fig{figs/fig-19d7d9b3.png}{Figure 3. Version of the graphical construction 
  shown in Fig. 1, appropriate to the original thermal friction model. Again, 
  three examples of possible positions of the sloping straight line are shown 
  in blue.} 
  ...
  \fig{figs/fig-393bf74e.png}{Figure 4. Plot corresponding to Fig. 4, for a 
  thermal model which assumed a temperature-dependent viscosity to represent 
  the behaviour of the rosin layer.} 
  ...
  \fig{figs/fig-be6e395e.png}{Figure 5. Plot corresponding to Fig. 3, for the 
  modified version of the thermal model as described in the text. The function 
  $\mathrm{sgn}(v)$ has been replaced by a hyperbolic curve tending 
  ...
  \fig{figs/fig-aa1a429b.png}{Figure 6. Coefficient of friction as a function 
  of temperature, deduced from the modified thermal friction model shown in 
  Fig. 5 after requiring that it should agree with the steady-sliding friction 
  measurements.} 