  ...
  \fig{figs/fig-a81fc57e.png}{\caption{Figure 1. Measured bridge force 
  waveforms of the note E$\_5$ (660~Hz) played on the open E string of a violin 
  (red curve), and as a fingered note high on the G string (blue curve)}} 
  ...
  \fig{figs/fig-96f11108.png}{\caption{Figure 2. Frequency spectra of the two 
  bridge force waveforms from Fig. 1: red curve for the E string, blue curve 
  for the G string. The arrows give an indication of the upper limit for 
  hearing of humans, dogs and cats.}} 
  ...
  \fig{figs/fig-6ef60827.png}{\caption{Figure 3. The successive stages of 
  building up a sawtooth wave from its Fourier series, repeated from Fig. 1 of 
  section 2.2}} 
  ...
  \fig{figs/fig-b8cc0c51.png}{\caption{Figure 4. Lothar Cremer (right) in 
  conversation with Carleen Hutchins in 1974}} 
  ...
  \fig{figs/fig-55384ee3.png}{\caption{Figure 5. Schematic diagram of the 
  simplest model of a bowed string, in the same format as Fig. 4 of section 8.5 
  for the clarinet model.}} 
  ...
  \fig{figs/fig-6fcb56be.png}{\caption{Figure 6. Blue stars show measurements 
  of the coefficient of friction for a rosin-coated surface during steady 
  sliding at different speeds. The red curve is a curve fit to those 
  measurements, together with the vertical portion relevant to sticking 
  friction, and the mirror image portion relevant to slipping in the opposite 
  direction.}} 
  ...
  \fig{figs/fig-681c38f5.png}{\caption{Figure 7. The friction curve from Fig. 
  6, together with three possible positions of the sloping blue line whose 
  intersection with the curve determines the new values of $v(t)$ and $f(t)$. 
  Friction force is plotted for two different values of the bow force: 10~N 
  (solid curve) and 1~N (dashed curve).}} 
  ...
  \fig{figs/fig-64d2ffbf.png}{\caption{Figure 8. The friction curve and sloping 
  straight lines as in Fig. 7, illustrating the hysteresis loop that arises 
  because of the possibility of multiple intersections between the red curve 
  and the moving blue line.}} 
  ...
  \fig{figs/fig-23f47812.png}{} 

  \fig{figs/fig-67e27452.png}{} 
  ...
  \fig{figs/fig-a7b4cec6.png}{\caption{Figure 10. The friction curve used in 
  the simulation shown in Fig. 9, illustrating the hysteresis cycle: the 
  portions of the curve accessed in the left-hand panel of Fig. 9 are shown in 
  blue, and those accessed in the right-hand panel are shown in blue.}} 
  ...
  \fig{figs/fig-1db8639d.png}{} 

  \fig{figs/fig-b19d4711.png}{} 

  \fig{figs/fig-00c7b67a.png}{\caption{Figure 12. The friction curve used in 
  the simulation of Fig. 11, plotted in the same format as Fig. 10.}} 
  ...
  \fig{figs/fig-44b90cc8.png}{\caption{Figure 13. Diagram to show the origin of 
  the pattern of ``Schelleng's ripples''. Time runs horizontally and distance 
  along the string runs vertically. The red line shows the path of the 
  Helmholtz corner, and the horizontal line marks the bowing position. Blue 
  lines show the first few bounces of the secondary waves generated when a 
  rounded Helmholtz corner interacts with friction at the bow during stick-slip 
  transitions.}} 
  ...
  \fig{figs/fig-3aac38b4.png}{\caption{Figure 14. Simulated bridge-force 
  waveforms for a highly idealised model of a bowed string, for three different 
  values of bow force. The red curve has a very low force, the blue curve is 
  higher, and the black curve is close to the limit at which Helmholtz motion 
  ceases to be possible. The curves are separated vertically for clarity.}} 
  ...
  \fig{figs/fig-3da58726.png}{\caption{Figure 15. Waveforms of string velocity 
  for the same three simulations shown in Fig. 14.}} 
