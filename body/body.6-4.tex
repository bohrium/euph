  ...
  \fig{figs/fig-59d6e8b2.png}{Figure 1. A sine wave at 200 Hz added to another 
  sine wave at 203 Hz with the same amplitude, leading to a pattern of beats. 
  The upper trace shows a 3 s segment, which you can listen to in Sound 1. The 
  ...
  \fig{figs/fig-e02e3030.png}{Figure 2. A sine wave at 200 Hz added to another 
  sine wave at 203 Hz with an amplitude 1/10 of the first one, leading to a 
  modulation pattern that is less strong than in Fig. 1, but still clearly 
  ...
  \fig{figs/fig-c4a8c2cd.png}{Figure 3. Five examples of auditory filters.} 
  ...
  \fig{figs/fig-19384dc4.png}{Figure 4. The bandwidth of auditory filters, 
  represented by the ERB, as a function of centre frequency.} 
  ...
  \fig{figs/fig-8a6ceb14.png}{Figure 6: A spectrogram of a note on a violin, 
  played with vibrato} 
  ...
  \fig{figs/fig-aacb878e.png}{Figure 7. A time-varying excitation pattern 
  plotted in a similar format to Fig. 6. The frequency scale is based on ERBs, 
  and thus on distance along the basilar membrane. Time runs vertically 
  upwards. The magnitude of the excitation pattern is represented by colour, on 
  a decibel scale given in the sidebar.} 
  ...
  \fig{figs/fig-3706f430.png}{Figure 8. Auditory spectrogram of Sound 4.} 
  ...
  frequency ratio of about 0.06%. Well, we cannot discern a difference as small 
