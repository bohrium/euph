  ...
  \fig{figs/fig-0b098ca0.png}{Figure 1. A sequence of rectangular pulses with 
  different widths, all having unit area.} 
  ...
  \fig{figs/fig-075f3ad9.png}{Figure 2. Illustration of convolution: see text} 
  ...
  \fig{figs/fig-3d8c79b4.png}{Figure 3. The input as in Fig. 2, together with 
  the sum of the responses to the finite strips, giving the jagged red line.} 
  ...
  \fig{figs/fig-5cd1f792.png}{Figure 4. Plot as in Fig. 3, after the width of 
  the strips has become very narrow.} 