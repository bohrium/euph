  ...
  \fig{figs/fig-0797953f.png}{\caption{Figure 1. Coefficient of friction 
  against string velocity, for a case with bow speed $v\_b=0.1$ m/s, 
  illustrating the condition for the maximum bow force when the Helmholtz slip 
  speed $v\_s=1$ m/s.}} 
  ...
  \begin{equation*}f_{pert} \approx \dfrac{Ty}{\beta L} = \dfrac{T^2 v_b t^2}{2 
