  ...
  \aud{auds/aud-a7f7ed8f-plot.png}{\caption{Sound 1. Synthesised sound of a 
  ``drum'' based on the frequency ratios of the ideal membrane as in Fig. 2.}} 

  \aud{auds/aud-6e303560-plot.png}{\caption{Sound 2. Synthesised sound based on 
  measured frequencies of a kettledrum membrane without the kettle, from 
  Christian et al. [1]}} 

  \aud{auds/aud-769143e4-plot.png}{\caption{Sound 3. Synthesised sound based on 
  measured frequencies of a kettledrum membrane with the kettle, from Christian 
  et al. [1]}} 
  ...
  \aud{auds/aud-9ff34335-plot.png}{\caption{Sound 4. Synthesised sound of an 
  Indian tuned drum, based on the frequencies measured by Rossing and Sykes [3] 
  on a mridanga}} 
