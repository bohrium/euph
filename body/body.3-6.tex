  ...
  \fig{figs/fig-eab55c67.png}{Figure 1. A typical drum kit.} 
  ...
  \fig{figs/fig-494d6e5a.png}{Figure 3. A typical kettledrum. This type has a 
  foot pedal that allows the membrane tension, and thus the pitch of the drum, 
  to be changed by the performer.} 
  ...
  \fig{figs/fig-f6db5bef.png}{Figure 4. Frequency ratios among the vibration 
  modes of two tuned drums. The modes are arranged in the same order as in Fig. 
  1, but are shown here via nodal line patterns for greater clarity. Red 
  figures: kettledrum, taken from Christian et al. [1] and reproduced in Table 
  18.2 of Fletcher and Rossing [2]; blue figures: mridanga (related to the 
  tabla), from Rossing and Sykes [3].} 
