  ...
  input-output ``black box'', reproduced from Fig. 2 of section 2.1.}} 
  ...
  \fig{figs/fig-e0eaffc1.png}{\caption{Figure 2. A cutaway view of a 
  loudspeaker. 1: magnet; 2: coil; 3: support structures; 4: cone. Image: Svjo, 
  ...
  \fig{figs/fig-c7a4485f.png}{\caption{Figure 3. A vibration shaker (the blue 
  cylinder) in use for an undergraduate experiment involving vibration of two 
  coupled cantilever beams.}} 

  \fig{figs/fig-9d4f659c.png}{\caption{Figure 4. Vibration shakers in different 
  sizes}} 
  ...
  \fig{figs/fig-6ad54574.png}{\caption{Figure 5. Two sizes of impact hammer, 
  both incorporating force-measuring sensors. The larger one is arranged in a 
  pendulum fixture, to ensure positional accuracy in repeated taps.}} 
  ...
  \fig{figs/fig-4964d37f.png}{\caption{Figure 6. The bridge admittance of a 
  violin, measured with three different excitation methods. Purple: impulse 
  hammer; blue: wire-break; red: bowed glissando.}} 
  ...
  \fig{figs/fig-69ebee70.png}{\caption{Figure 7. Measuring the input impedance 
  of a saxophone, reproduced from Fig. 5 of section 8.5. The measurement is 
  taking place in an anechoic chamber: the wedges on the walls absorb the sound 
  waves so that there is virtually no reflection. Image copyright Jean-Pierre 
  Dalmont, reproduced by permission.}} 
  ...
  \fig{figs/fig-1e2edc0f.png}{\caption{Figure 8. Three different sizes of 
  accelerometer: only the smallest one is light enough for use with stringed 
  instruments.}} 
  ...
  \fig{figs/fig-a9ee6a1e.png}{\caption{Figure 9. A small accelerometer being 
  used to measure vibration of a harp soundboard}} 
  ...
  \fig{figs/fig-72dbdd3f.png}{\caption{Figure 10. A laser-Doppler vibrometer 
  (foreground) being used to measure vibration of a banjo. Note the red spot on 
  the banjo bridge, where the laser beam strikes.}} 
  ...
  \fig{figs/fig-bd4fa8d7.png}{\caption{Figure 11. Admittance (red) and 
  accelerance (blue) measured at the bridge of a violin. The admittance shows 
  calibrated values, but the accelerance has been scaled down by a factor of 
  10,000 (i.e. shifted by 80 dB) so that it fits on the same vertical scale.}} 
  ...
  \fig{figs/fig-798d7354.png}{\caption{Figure 12. The violin admittance from 
  Fig. 11, labelled with key features.}} 
  ...
  \fig{figs/fig-5c24031a.png}{\caption{Figure 13. Measured frequency responses 
  of a violin. Black: bridge admittance; red and blue: microphone responses to 
  a bridge tap, at two different positions in a medium-sized room.}} 
  ...
  \fig{figs/fig-7ff38a1b.png}{\caption{Figure 14. Zoomed view of part of Fig. 
  13, showing some of the characteristic features of room acoustics.}} 
  ...
  \fig{figs/fig-6df3eb2a.png}{\caption{Figure 15. Frequency responses of the 
  same violin as in Fig. 13. Black: bridge admittance as before; red: 
  microphone response in the same room as Fig. 13, but with the microphone 
  closer to the violin; blue: the same microphone position relative to the 
  violin, but measured in a more ``dead'' room.}} 
  ...
  \fig{figs/fig-2b17c206.png}{\caption{Figure 16. The distribution of 
  microphone positions around a violin body, used in the measurements by George 
  Bissinger. Red stars are positions on the front side of the violin, blue ones 
  on the back.}} 
