  ...
  \fig{figs/fig-c7a4485f.png}{Figure 3. A vibration shaker (the blue cylinder) 
  in use for an undergraduate experiment involving vibration of two coupled 
  cantilever beams.} 

  \fig{figs/fig-9d4f659c.png}{Figure 4. Vibration shakers in different sizes} 
  ...
  \fig{figs/fig-6ad54574.png}{Figure 5. Two sizes of impact hammer, both 
  incorporating force-measuring sensors. The larger one is arranged in a 
  ...
  \fig{figs/fig-4964d37f.png}{Figure 6. The bridge admittance of a violin, 
  measured with three different excitation methods. Purple: impulse hammer; 
  blue: wire-break; red: bowed glissando.} 
  ...
  \fig{figs/fig-69ebee70.png}{Figure 7. Measuring the input impedance of a 
  saxophone, reproduced from Fig. 5 of section 8.5. The measurement is taking 
  place in an anechoic chamber: the wedges on the walls absorb the sound waves 
  so that there is virtually no reflection. Image copyright Jean-Pierre 
  ...
  \fig{figs/fig-1e2edc0f.png}{Figure 8. Three different sizes of accelerometer: 
  only the smallest one is light enough for use with stringed instruments.} 
  ...
  \fig{figs/fig-a9ee6a1e.png}{Figure 9. A small accelerometer being used to 
  measure vibration of a harp soundboard} 
  ...
  \fig{figs/fig-72dbdd3f.png}{Figure 10. A laser-Doppler vibrometer 
  ...
  \fig{figs/fig-bd4fa8d7.png}{Figure 11. Admittance (red) and accelerance 
  (blue) measured at the bridge of a violin. The admittance shows calibrated 
  values, but the accelerance has been scaled down by a factor of 10,000 (i.e. 
  shifted by 80 dB) so that it fits on the same vertical scale.} 
  ...
  \fig{figs/fig-798d7354.png}{Figure 12. The violin admittance from Fig. 11, 
  labelled with key features.} 
  ...
  \fig{figs/fig-5c24031a.png}{Figure 13. Measured frequency responses of a 
  violin. Black: bridge admittance; red and blue: microphone responses to a 
  bridge tap, at two different positions in a medium-sized room.} 
  ...
  \fig{figs/fig-7ff38a1b.png}{Figure 14. Zoomed view of part of Fig. 13, 
  showing some of the characteristic features of room acoustics.} 
  ...
  \fig{figs/fig-6df3eb2a.png}{Figure 15. Frequency responses of the same violin 
  as in Fig. 13. Black: bridge admittance as before; red: microphone response 
  in the same room as Fig. 13, but with the microphone closer to the violin; 
  blue: the same microphone position relative to the violin, but measured in a 
  more ``dead'' room.} 
  ...
  \fig{figs/fig-2b17c206.png}{Figure 16. The distribution of microphone 
  positions around a violin body, used in the measurements by George Bissinger. 
  Red stars are positions on the front side of the violin, blue ones on the 
  back.} 
