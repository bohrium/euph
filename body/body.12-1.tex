...
\moobeginvid\begin{tabular}{ccc} \vidframe{ 0.30 }{ vids/vid-8ea64739-00.png }&\vidframe{ 0.30 }{ vids/vid-8ea64739-01.png }&\vidframe{ 0.30 }{ vids/vid-8ea64739-02.png } \end{tabular}\caption{Figure 2. The more usual behaviour of Newton's cradle, with a row of identical balls.}\mooendvideo
  ...
  \aud{auds/aud-c7f60cff-plot.png}{\caption{Sound 1. The sound of the velocity 
  waveform at the struck point on the plate, for the plate-drumstick impact 
  corresponding to the green circle in the middle of Fig. 20.}} 

  \aud{auds/aud-13c13b99-plot.png}{\caption{Sound 2. A sound corresponding to 
  Sound 1, for the impact marked by the left-hand blue circle in Fig. 20. The 
  contact stiffness is the same as for Sound 1, but the drumstick mass is 
  lower.}} 

  \aud{auds/aud-cb61c4a8-plot.png}{\caption{Sound 3. A sound corresponding to 
  Sound 1, for the impact marked by the right-hand blue circle in Fig. 20. The 
  contact stiffness is the same as for Sound 1, but the drumstick mass is 
  higher.}} 

  \aud{auds/aud-2e8cd7a8-plot.png}{\caption{Sound 4. A sound corresponding to 
  Sound 1, for the impact marked by the blue circle near the bottom of Fig. 20. 
  The drumstick mass is the same as for Sound 1, but the contact stiffness is 
  lower.}} 

  \aud{auds/aud-8388cb2b-plot.png}{\caption{Sound 5. A sound corresponding to 
  Sound 1, for the impact marked by the black circle near the top of Fig. 20. 
  The drumstick mass is the same as for Sound 1, but the contact stiffness is 
  higher.}} 
  ...
  \aud{auds/aud-76a0edcc-plot.png}{\caption{Sound 6. The sound of the velocity 
  waveform at the struck point on the plate, for the plate-drumstick impact 
  corresponding to the green circle in Fig. 26, with a flexible drumstick.}} 

  \aud{auds/aud-86bf1ab0-plot.png}{\caption{Sound 7. Corresponding sound to 
  Sound 6, for the case with a rigid drumstick.}} 

  \aud{auds/aud-5b6998e5-plot.png}{\caption{Sound 8. The sound of the velocity 
  waveform at the struck point on the plate for the case marked by a black 
  circle in Fig. 26, with a flexible drumstick.}} 

  \aud{auds/aud-4f18662d-plot.png}{\caption{Sound 9. Corresponding sound to 
  Sound 8, for the case with a rigid drumstick.}} 
