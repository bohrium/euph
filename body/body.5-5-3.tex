  ...
  \fig{figs/fig-72f3bbb8.png}{\caption{Figure 1. The original bridge, and a 
  ``bridge'' made from a solid block of poplar with the same mass and height}} 

  \fig{figs/fig-4ad5cc78.png}{\caption{Figure 2. Bridge admittances for the 
  poplar block bridge (solid curves), compared to the original bridge (dotted 
  curves). Black and blue: string 1 position; red and magenta: string 3 
  position.}} 
  ...
  \aud{auds/aud-d2907a1d-plot.png}{\caption{Sound 1. Synthesis using the 
  original bridge}} 

  \aud{auds/aud-a3d4b4d4-plot.png}{\caption{Sound 2. Synthesis using the poplar 
  block bridge}} 
  ...
  \fig{figs/fig-e4b7e4f2.png}{\caption{Figure 3. Three variations on a 
  ``violin-shaped'' bridge: the second has the middle leg trimmed short, and 
  the third has a cut to reduce the bending stiffness}} 
  ...
  \fig{figs/fig-26e5a6db.png}{\caption{Figure 4. Admittances of the first 
  bridge from Fig. 3, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 

  \fig{figs/fig-1bd6a186.png}{\caption{Figure 5. Admittances of the second 
  bridge from Fig. 3, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 

  \fig{figs/fig-613b19c6.png}{\caption{Figure 6. Admittances of the third 
  bridge from Fig. 3, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 
  ...
  \aud{auds/aud-e625a625-plot.png}{\caption{Sound 3. Synthesis using the first 
  bridge from Fig. 3.}} 

  \aud{auds/aud-9da2b97f-plot.png}{\caption{Sound 4. Synthesis using the second 
  bridge from Fig. 3.}} 

  \aud{auds/aud-fc7b05eb-plot.png}{\caption{Sound 5. Synthesis using the third 
  bridge from Fig. 3.}} 
  ...
  \fig{figs/fig-3eee34f1.png}{\caption{Figure 7. Two bridges of unusual design: 
  a Weitzel 6-10, and a Donald New ``spillway dam''.}} 

  \fig{figs/fig-ce165220.png}{\caption{Figure 8. Admittances of the first 
  bridge from Fig. 7, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 

  \fig{figs/fig-9c45f599.png}{\caption{Figure 9. Admittances of the second 
  bridge from Fig. 7, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 

  \aud{auds/aud-bcc70984-plot.png}{\caption{Sound 6. Synthesis using the first 
  bridge from Fig. 7.}} 

  \aud{auds/aud-c5d27ed4-plot.png}{\caption{Sound 7. Synthesis using the second 
  bridge from Fig. 3.}} 
  ...
  \fig{figs/fig-9c565c9f.png}{\caption{Figure 10. Three bridges by Bart 
  Veerman. The first pair are similar except that the first has a curved base 
  contour while the second is flat. The third bridge is the only one of this 
  set with a different mass: about 1.2~g compared to 2.2~g for all the 
  others.}} 

  \fig{figs/fig-7bdc7af6.png}{\caption{Figure 11. Admittances of the first 
  bridge from Fig. 10, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 

  \fig{figs/fig-4ddf407e.png}{\caption{Figure 12. Admittances of the second 
  bridge from Fig. 10, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 

  \fig{figs/fig-f71124ee.png}{\caption{Figure 13. Admittances of the third 
  bridge from Fig. 10, compared with the original Deering bridge in the same 
  format as Fig. 2.}} 

  \aud{auds/aud-ba246e0b-plot.png}{\caption{Sound 8. Synthesis using the first 
  bridge from Fig. 10.}} 

  \aud{auds/aud-0ee8174e-plot.png}{\caption{Sound 9. Synthesis using the second 
  bridge from Fig. 10.}} 

  \aud{auds/aud-832a6dec-plot.png}{\caption{Sound 10. Synthesis using the third 
  bridge from Fig. 10.}} 