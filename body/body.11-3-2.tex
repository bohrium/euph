  ...
  \fig{figs/fig-f1c60553.png}{Figure 1. The scaled input impedance $Z/Z_t$ of a 
  clarinet-like cylindrical tube, normalised by the characteristic impedance. 
  The red curve shows the result according to the method described in section 
  11.1.1, the blue curve shows a modified version with increased damping at 
  higher frequencies.} 
  ...
  \fig{figs/fig-37a64b13.png}{Figure 3. Impulse response of an idealised 
  clarinet tube, obtained by inverse FFT of the blue impedance from Fig. 1.} 
  ...
  \fig{figs/fig-78a02e24.png}{Figure 4. Reflection function corresponding to 
  the impulse response in Fig. 3, obtained by processing the impedance with 
  equation (4) then taking an inverse FFT.} 
