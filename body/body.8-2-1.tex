  ...
  \fig{figs/fig-f607a5ff.png}{\caption{Figure 1. Sketch of a simple pendulum}} 

  The only external force acting on the mass is gravity, so taking moments 
  about the pivot we obtain 

  \begin{equation*}m L^2 \ddot{\theta} = -mgL \sin \theta .\end{equation*} 

  We can rewrite this to look like the equation of an equivalent mass-spring 
  oscillator: 

  \begin{equation*}m \ddot{\theta} + \dfrac{mg}{L} \sin \theta =0 
  ,\end{equation*} 

  \noindent{}so that the equivalent ``nonlinear spring'' has the 
  force-``displacement'' relation $(mg/L) \sin \theta$. 
  ...
  \fig{figs/fig-dfd5d512.png}{\caption{Figure 2. Equivalent spring behaviour of 
  the pendulum}} 
  ...
  \begin{equation*}\sin \theta \approx \theta -- \dfrac{\theta^3}{3!} 
  .\end{equation*} 
