  ...
  \fig{figs/fig-c6f19a7e.png}{Figure 2. Sketch of a grid of microphone 
  ...
  \fig{figs/fig-a5c80e97.png}{Figure 6. NAH reconstruction of the sound 
  intensity from a violin body driven at the second harmonic of the open D 
  string, on a plane not quite touching the top plate of the violin. The format 
  is the same as in Fig. 11. Images reproduced from Wang and Burroughs [3], by 
  permission of the authors.} 

  \fig{figs/fig-a61fa3f0.png}{Figure 7. NAH reconstruction of the sound 
  intensity from a violin body driven at the second harmonic of the open D 
  string, on the plane through the mid-line of the body. Images reproduced from 
  Wang and Burroughs [3], by permission of the authors.} 
  ...
  \fig{figs/fig-9a0232b3.png}{Figure 8. NAH reconstruction of the sound 
  intensity from a violin body driven at the third harmonic of the open A 
  ...
  \fig{figs/fig-776aaeca.png}{Figure 12. Four successive schlieren images 
  showing a shock wave radiating from the bell of a trumpet being driven with a 
  loudspeaker at the mouthpiece end. Image reproduced from López-Carromero et 
  al. [4] by permission of the authors.} 
  ...
  \fig{figs/fig-edfdeeeb.png}{Figure 13. A sequence of schlieren images of an 
  air jet in a recorder-like instrument. The jet comes from the left, and 
  impinges on a sharp-edged wedge on the right. Flow instabilities lead to the 
  jet moving around and shedding vortices. To give a strong density contrast 
  for schlieren imaging, carbon dioxide rather than air forms the jet. Image 
  copyright Avraham Hirshberg, reproduced by permission.} 
  ...
  \fig{figs/fig-9602b720.png}{Figure 14. Upper plot: a PIV measurement of flow 
  velocity at a grid of points near the end of a vertical pipe, being driven 
  sinusoidally by a loudspeaker. Lower left plot: the flow speed (colours) and 
  the streamline pattern (black lines); Lower right plot: the vorticity of the 
  flow, deduced by processing the measured velocity field. Image copyright 
  David Skulina, reproduced by permission.} 
