  ...
  \fig{figs/fig-96d24a39.png}{} 

  \fig{figs/fig-e87f0f3e.png}{} 

  \fig{figs/fig-c9f8be05.png}{} 

  \fig{figs/fig-b31e1eaf.png}{} 
  ...
  \fig{figs/fig-c6f19a7e.png}{\caption{Figure 2. Sketch of a grid of microphone 
  positions above the top plate of a guitar, suitable for carrying out NAH 
  tests.}} 
  ...
  \fig{figs/fig-9929f4bd.png}{} 

  \fig{figs/fig-3fac6d85.png}{} 
  ...
  \fig{figs/fig-dcdc40fe.png}{} 

  \fig{figs/fig-94493846.png}{} 
  ...
  \fig{figs/fig-76dae754.png}{} 

  \fig{figs/fig-d1da038c.png}{} 
  ...
  \fig{figs/fig-a5c80e97.png}{\caption{Figure 6. NAH reconstruction of the 
  sound intensity from a violin body driven at the second harmonic of the open 
  D string, on a plane not quite touching the top plate of the violin. The 
  format is the same as in Fig. 11. Images reproduced from Wang and Burroughs 
  [3], by permission of the authors.}} 

  \fig{figs/fig-a61fa3f0.png}{\caption{Figure 7. NAH reconstruction of the 
  sound intensity from a violin body driven at the second harmonic of the open 
  D string, on the plane through the mid-line of the body. Images reproduced 
  from Wang and Burroughs [3], by permission of the authors.}} 
  ...
  \fig{figs/fig-9a0232b3.png}{\caption{Figure 8. NAH reconstruction of the 
  sound intensity from a violin body driven at the third harmonic of the open A 
  string, on the plane through the mid-line of the body. The format is the same 
  as Fig. 7. Images reproduced from Wang and Burroughs [3], by permission of 
  the authors.}} 
  ...
  \fig{figs/fig-0402a395.png}{\caption{Figure 9. A two-mirror setup for 
  schlieren photography. Image: NathanHagen, CC BY-SA 4.0 
  ...
  \fig{figs/fig-3d024a7d.png}{\caption{Figure 10. A schlieren image of heat 
  rising from a hot soldering iron. Image: Iansmith6, CC BY 3.0 
  https://creativecommons.org/licenses/by/3.0, via Wikimedia Commons}} 

  \fig{figs/fig-a23d2fd3.png}{\caption{Figure 11. A schlieren image of a bullet 
  moving at supersonic speed, showing shock waves and the turbulent wake. 
  Image: Nathan Boor, CC BY 4.0 https://creativecommons.org/licenses/by/4.0, 
  ...
  \fig{figs/fig-776aaeca.png}{\caption{Figure 12. Four successive schlieren 
  images showing a shock wave radiating from the bell of a trumpet being driven 
  with a loudspeaker at the mouthpiece end. Image reproduced from 
  López-Carromero et al. [4] by permission of the authors.}} 
  ...
  \fig{figs/fig-edfdeeeb.png}{\caption{Figure 13. A sequence of schlieren 
  images of an air jet in a recorder-like instrument. The jet comes from the 
  left, and impinges on a sharp-edged wedge on the right. Flow instabilities 
  lead to the jet moving around and shedding vortices. To give a strong density 
  contrast for schlieren imaging, carbon dioxide rather than air forms the jet. 
  Image copyright Avraham Hirshberg, reproduced by permission.}} 
  ...
  \fig{figs/fig-9602b720.png}{\caption{Figure 14. Upper plot: a PIV measurement 
  of flow velocity at a grid of points near the end of a vertical pipe, being 
  driven sinusoidally by a loudspeaker. Lower left plot: the flow speed 
  (colours) and the streamline pattern (black lines); Lower right plot: the 
  vorticity of the flow, deduced by processing the measured velocity field. 
  Image copyright David Skulina, reproduced by permission.}} 
