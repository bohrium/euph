  ...
  \fig{figs/fig-d808aa0a.png}{Figure 1. A complex number $z=x+iy$ in the Argand 
  diagram (red dot). The complex conjugate $z^*$ is shown as a blue dot. The 
  magnitude $r$ and the phase (or argument) $\theta$ are also shown.} 
