  ...
  \fig{figs/fig-e7417636.png}{\caption{Figure 1. A modern violin bow (lower), 
  and a treble viol bow (upper)}} 

  \fig{figs/fig-8e49ce95.png}{\caption{Figure 2. Closeup of the the tips of the 
  two bows in Fig. 1.}} 
  ...
  \fig{figs/fig-98160f26.png}{\caption{Figure 3. The violin bow from Fig. 1, 
  labelled to show the balance point and centre of percussion}} 
  ...
  \fig{figs/fig-f3ebfffe.png}{\caption{Figure 4. Bow-bouncing resonance 
  frequency as a function of position along the bow hair, according to the 
  simplified theory of Askenfelt and Guettler [1].}} 
  ...
  \fig{figs/fig-2c47e34c.png}{\caption{Figure 5. Guettler diagram, measured in 
  the Galluzzo rig using a real cello bow.}} 

  \fig{figs/fig-af307b6d.png}{\caption{Figure 6. Measured Guettler diagram as 
  seen in section 9.5, using a rosin-coated rod.}} 
  ...
  \fig{figs/fig-8520ace5.png}{\caption{Figure 7. Schematic sketch of one rough 
  surface sliding over another, with contact only at the tips of asperities.}} 
  ...
  \aud{auds/aud-b798766c-plot.png}{\caption{Sound 1. Extract from a 
  bridge-force recording of the open G string of a violin, illustrating a 
  characteristic harsh sound towards the end}} 
  ...
  \fig{figs/fig-960ba1c0.png}{\caption{Figure 8. Two samples of the waveform of 
  Sound 1, extracted early and late in the sequence. Both show the Helmholtz 
  sawtooth, with irregular ``spikes'' superimposed}} 
  ...
  \fig{figs/fig-a5619725.png}{\caption{Figure 9. Sketch of what would need to 
  happen if the string were to stick to the entire width of the bow during 
  Helmholtz motion. The upper image shows the situation just after the 
  Helmholtz corner has passed the bow. The lower image shows what would happen 
  by the time the Helmholtz corner was arriving back near the bow.}} 
  ...
  \fig{figs/fig-965bd2b3.png}{\caption{Figure 10. Simulated example of a bridge 
  force waveform with a finite-width bow, showing Helmholtz motion with 
  irregular ``spikes'' caused by localised slips on the side of the bow facing 
  the bridge.}} 
  ...
  \fig{figs/fig-b05afff4.png}{\caption{Figure 11. The pattern of sticking 
  (black) and slipping (white) across the width of the bow for the waveform 
  section plotted in Fig. 10. Red pixels show slipping in the reverse 
  direction. The edge of the bow nearest to the bridge is at the top.}} 
  ...
  \fig{figs/fig-2cfc9a4b.png}{} 

  \fig{figs/fig-d40315ab.png}{} 

  \fig{figs/fig-b6952b0e.png}{} 

  \fig{figs/fig-c2bbd1b0.png}{} 

  \fig{figs/fig-a20e6ce3.png}{} 

  \fig{figs/fig-ac3c8af2.png}{} 
  ...
  \fig{figs/fig-aad88492.png}{} 

  \fig{figs/fig-00574858.png}{} 

  \fig{figs/fig-e1f625ce.png}{} 

  \fig{figs/fig-87f508f7.png}{} 

  \fig{figs/fig-a9bc96e7.png}{} 

  \fig{figs/fig-3ef5d27b.png}{} 
  ...
  \fig{figs/fig-bd02fd43.png}{\caption{Figure 15. A renaissance bass viol made 
  by Richard Jones, being played by Patsy Campbell during the ``warble'' 
  ...
  \aud{auds/aud-6bc55040-plot.png}{\caption{Sound 2. Three notes played on the 
  bass viol from Fig. 15, illustrating the ``warble'' effect}} 
  ...
  \fig{figs/fig-68ab64ed.png}{\caption{Figure 16. Spectrogram of Sound 2, 
  showing the ``warble'' as fairly regular modulation of some of the harmonics, 
  especially numbers 4 and above}} 
  ...
  \fig{figs/fig-1bde7566.png}{\caption{Figure 17. A spectrogram of bowhair 
  vibration measured by a small accelerometer near the frog, during a bow 
  change upbow--downbow. The curving lines of bright spots show the frequency 
  variation of harmonics of transverse vibration of the hair between the string 
  contact and the frog.}} 

  \aud{auds/aud-7a0c6481-plot.png}{\caption{Sound 3. Recording from an 
  accelerometer attached to the bow hair of the viol bow seen in Fig. 15, 
  during the bow change analysed in Fig. 17.}} 
