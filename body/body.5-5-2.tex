  ...
  \aud{auds/aud-1e2e474a-plot.png}{\caption{Sound X.1. Synthesised example 
  filtered with $\beta=0$.}} 

  \aud{auds/aud-cfa8cdaf-plot.png}{\caption{Sound X.2. Synthesised example 
  filtered with $\beta=0.3$.}} 

  \aud{auds/aud-70e1db8a-plot.png}{\caption{Sound X.3. Synthesised example 
  filtered with $\beta=0.4$.}} 

  \aud{auds/aud-0db13ecd-plot.png}{\caption{Sound X.4. Synthesised example 
  filtered with $\beta=0.5$.}} 

  \aud{auds/aud-8858ea02-plot.png}{\caption{Sound X.5. Synthesised example 
  filtered with $\beta=0.7$.}} 

  \aud{auds/aud-4506759f-plot.png}{\caption{Sound X.6. Synthesised example 
  filtered with $\beta=1$.}} 
  ...
  \fig{figs/fig-cf89d973.png}{\caption{Figure 1. Computed response from the 
  FE/BE model: bridge admittance (black) and field pressure at a typical 
  position (red) in response to driving on the bridge at the position of the 
  first string. The dashed blue curve shows the ratio of the two, used to 
  filter the output signal to make Sounds X.8 and X.9.}} 

  \aud{auds/aud-67d90609-plot.png}{\caption{Sound X.7. Synthesised example 
  based on the bridge admittance from the FE/BE model, but filtered with the 
  standard filter with $\beta=0.4$.}} 

  \aud{auds/aud-6e149549-plot.png}{\caption{Sound X.8. Synthesised example 
  using the admittance and sound radiation to a particular sensing position 
  computed by the FE/BE model.}} 

  \aud{auds/aud-16681f0b-plot.png}{\caption{Sound X.9. Example similar to Sound 
  X.8, but filtered with the magnitude-only version of the filter used for 
  Sound X.8.}} 
  ...
  \aud{auds/aud-87ab35c0-plot.png}{\caption{Sound X.10 Synthesised example from 
  the square banjo model without any additional dashpot applied at the 
  bridge.}} 

  \aud{auds/aud-ee5e3a79-plot.png}{\caption{Sound X.11. Synthesised example 
  from the square banjo model with a dashpot applied at the bridge with 
  strength 0.5 Ns/m.}} 

  \aud{auds/aud-61344fbd-plot.png}{\caption{Sound X.12. Synthesised example 
  from the square banjo model with a dashpot applied at the bridge with 
  strength 1 Ns/m. This is the value used in the datum model.}} 

  \aud{auds/aud-caf9ddc9-plot.png}{\caption{Sound X.13. Synthesised example 
  from the square banjo model with a dashpot applied at the bridge with 
  strength 2 Ns/m.}} 

  \aud{auds/aud-8fa3b128-plot.png}{\caption{Sound X.14. Synthesised example 
  from the square banjo model with a dashpot applied at the bridge with 
  strength 5 Ns/m.}} 
  ...
  \aud{auds/aud-c022c4d6-plot.png}{\caption{Sound X.15. Synthesis with the 
  square banjo model, applying the delay ``compensation'' but with a negative 
  delay of $-20 \mu$s.}} 

  \aud{auds/aud-08257b24-plot.png}{\caption{Sound X.16. Synthesis with the 
  square banjo model, without any delay ``compensation''.}} 

  \aud{auds/aud-844e68a0-plot.png}{\caption{Sound X.17. Synthesis with the 
  square banjo model, applying the delay ``compensation'' with a delay of $20 
  \mu$s. This is the value used in the datum model.}} 

  \aud{auds/aud-1dacdf16-plot.png}{\caption{Sound X.18. Synthesis with the 
  square banjo model, applying the delay ``compensation'' with a delay of $40 
  \mu$s.}} 

  \aud{auds/aud-e6ef97d5-plot.png}{\caption{Sound X.19. Synthesis with the 
  square banjo model, applying the delay ``compensation'' with a delay of $60 
  \mu$s.}} 
