  ...
  \fig{figs/fig-ce7f5a49.png}{\caption{Figure 1. Sketch of the geometry, 
  showing three cylindrical tubes joined at the point O.}} 
  ...
  \begin{equation*}A_1 e^{-ikL} + B_1 e^{ikl} =0. \tag{3}\end{equation*} 
