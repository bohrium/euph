  ...
  \fig{figs/fig-6b7e2ddc.png}{\caption{Figure 1. Force-displacement relation 
  for an ideal spring obeying Hooke's law. Units are deliberately omitted from 
  the axes here, because the qualitative behaviour is all that we are 
  interested in.}} 
  ...
  \fig{figs/fig-3ad30c6c.png}{\caption{Figure 2. Force displacement relations 
  for nonlinear springs. The red curve shows a hardening spring, the blue curve 
  shows a softening spring. They deviate in opposite directions from the 
  straight line describing Hooke's law, shown as a black dash-dot line.}} 
  ...
  \fig{figs/fig-ef28f5d3.png}{\caption{Figure 3. Response of a Duffing 
  oscillator with a hardening spring to sinusoidal excitation. Black curve: 
  linear response. Red curve: approximate nonlinear response. The blue circles 
  show the ``backbone curve'': the position of the peak of the red curve for 
  different excitation levels, and equivalently the path followed by the 
  frequency during a free decay.}} 
  ...
  \fig{figs/fig-df128fec.png}{\caption{Figure 4. Duffing oscillator as in Fig. 
  3, showing the pattern of response to sinusoidal forcing with a gradually 
  rising frequency (green arrows) and a gradually falling frequency (blue 
  arrows). Jumps occur in both directions, but the jump on the green path is 
  much bigger than the one on the blue path.}} 
  ...
  \fig{figs/fig-cf75d86d.png}{\caption{Figure 5. Duffing oscillator as in Fig. 
  3, but with the sign of the nonlinear term reversed so that it has a 
  softening spring.}} 
  ...
  \fig{figs/fig-65fdd22c.png}{\caption{Figure 6. Force displacement relations 
  for nonlinear springs. The red curve shows a hardening spring, as in Fig. 2. 
  The red dashed curve shows an extreme example of a hardening spring: a linear 
  spring with end-stops}} 
  ...
  \fig{figs/fig-e64bdcd2.png}{\caption{Figure 7. Force-displacement behaviour 
  for a spring with a loose connector, showing a ``dead band'' in the middle 
  region where no force is exerted.}} 
  ...
  \fig{figs/fig-12f9e80f.png}{\caption{Figure 8. Input-output behaviour of an 
  amplifier showing hard clipping (red curve) or soft clipping (blue curve).}} 
  ...
  \fig{figs/fig-c75562f3.png}{\caption{Figure 9. Coulomb's idealised model of 
  friction force as a function of the sliding speed between two objects in 
  contact. The vertical portion indicates sticking friction: when the sliding 
  speed is zero, the force can take any value between two limits. The 
  horizontal portions show what happens once there is relative sliding: the 
  force stays constant, with a direction that opposes the sliding motion.}} 
  ...
  \fig{figs/fig-cb46a15c.png}{\caption{Figure 10. A slightly more realistic 
  model of friction than Fig. 9. The friction force during sliding is no longer 
  fixed: when the sliding is very slow, the force is quite large, but with 
  faster sliding the friction force reduces.}} 
  ...
  \fig{figs/fig-bac529dc.png}{\caption{Figure 11. Displacement against time for 
  a mass-spring oscillator with a friction damper that obeys Coulomb's law.}} 
