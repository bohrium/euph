  ...
  \fig{figs/fig-8ff9a099.png}{Figure 1. Nonlinear response of an amplifier: the 
  dotted sine wave is the desired output, but if clipping occurs the actual 
  output will be like the red curve.} 
  ...
  \fig{figs/fig-f7eb68d7.png}{Figure 2. Schematic plot of an amplifier showing 
  ``soft clipping'', to be contrasted with the ``hard clipping'' in Fig. 1.} 
