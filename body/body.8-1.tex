  ...
  \aud{auds/aud-f1dfe740-plot.png}{\caption{Sound 1. A sine wave, then the 
  hard-clipped version of the same sine wave as plotted in Fig. 1.}} 
  ...
  \aud{auds/aud-da36a48b-plot.png}{\caption{Sound 2. Demonstration of soft 
  clipping, in the same format as Sound 1, using the waveforms plotted in Fig. 
  2}} 
