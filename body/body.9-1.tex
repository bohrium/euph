...
\moobeginvid\begin{tabular}{ccc} \vidframe{ 0.30 }{ vids/vid-049e619e-00.png }&\vidframe{ 0.30 }{ vids/vid-049e619e-01.png }&\vidframe{ 0.30 }{ vids/vid-049e619e-02.png } \end{tabular}\caption{Figure 2.  Animation of Helmholtz motion of a bowed string, in idealised form. Top panel shows the string motion, and the moving bow. Lower panel shows the transverse force exerted on the bridge of the instrument, which is the source of body vibration.}\mooendvideo
  ...
  \aud{auds/aud-e9496787-plot.png}{\caption{Sound 1. The violin extract shown 
  in Figs. 7 and 8, recorded with a bridge-force sensor.}} 
  ...
  \aud{auds/aud-3ae2b5ef-plot.png}{\caption{Sound 2. A periodic waveform based 
  on one cycle of measured bridge force while playing Helmholtz motion on the 
  open G string of a violin}} 

  \aud{auds/aud-eb3dbd26-plot.png}{\caption{Sound 3. A periodic waveform based 
  on one cycle of measured bridge force while playing double-slipping motion on 
  the same open G string of a violin as in Sound 2}} 
