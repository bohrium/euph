  ...
  \samsection{A:} \samsection{Distribution of loss factors} 
  ...
  \fig{figs/fig-fb90a851.png}{Figure 1. Spectrogram of the note $G_4$ (392 Hz), 
  played with a plectrum on the top string of a banjo.} 
  ...
  \fig{figs/fig-32b58107.png}{Figure 2. Loss factor versus frequency for modes 
  excited by plucking the top string of a guitar. Red circles and stars show 
  measured values; black dots show the predicted loss factor for energy flow 
  into the body alone, calculated from the measured bridge admittance. The 
  analysis method cannot detect modes significantly above the magenta line. 
  Green dashed lines indicate decay time constants $\tau$ = 50 ms (top line), 
  100 ms, 200 ms, 300 ms and 400 ms (lowest line).} 

  \fig{figs/fig-a5bccc69.png}{Figure 3. Loss factor versus frequency for modes 
  excited by plucking the top string of a banjo, in the same format as Fig. 2.} 
  ...
  \samsection{B: }\samsection{Models and datum cases} 
  ...
  \fig{figs/fig-17fa1cab.png}{Figure 4. Bridge admittances used in synthesis. 
  The solid red line is the datum admittance corresponding to Sound B.1, 
  measured on the bridge of the Deering banjo near the first string, with the 
  resonator back fitted to the banjo. The dotted red line shows the 
  ...
  \samsection{C: Different measured admittances} 
  ...
  \fig{figs/fig-c7145ef4.png}{Figure 5. Admittance at three positions on the 
  banjo bridge, reproduced from Fig. 17 of section 5.3.} 
  ...
  \fig{figs/fig-ec0d7d73.png}{Figure 6. The banjo being tested with the rigid 
  circular bridge, carrying only one string.} 
  ...
  \fig{figs/fig-0d6af2c8.png}{Figure 7. Measured bridge admittances of the 
  Deering banjo without its resonator back. Blue curve: circular bridge at the 
  centre of the membrane; black curve: circular bridge offset from the centre; 
  red dashed curve: regular bridge, measured near the first string as in Fig. 
  4.} 
  ...
  \fig{figs/fig-c4454b0c.png}{Figure 8. Bridge admittances of a steel-string 
  guitar (black solid), a flamenco guitar (black dashed) and a violin (blue), 
  compared to the datum admittance of the banjo (red).} 
  ...
  \samsection{D: Strings and plucking} 
  ...
  \samsection{E. Alternative synthesis methods} 
  ...
  \fig{figs/fig-45232de7.png}{Figure 9. Spectrogram of the sample music 
  fragment, synthesised using ``string modes'' only.} 

  \fig{figs/fig-4707ec3a.png}{Figure 10. Spectrogram of the sample music 
  fragment, synthesised using ``body modes'' only.} 

  \samsection{F. Tension and size of head membrane} 
  ...
  \fig{figs/fig-02967916.png}{Figure 11. The bridge admittances associated with 
  Sounds F.2 (blue curve), F.3 (the datum case, red curve) and F.5 (black 
  curve).} 
  ...
  \fig{figs/fig-b1ac0df4.png}{Figure 12. The bridge admittances associated with 
  Sounds F.6 (blue curve), F.8 (the datum case, red curve) and F.10 (black 
  curve).} 
  ...
  \samsection{G. Bridge mass and added stiffness} 
  ...
  \fig{figs/fig-a020d056.png}{Figure 13. The bridge admittances associated with 
  Sounds G.1 (blue curve), G.3 (red curve) and G.6 (black curve).} 
  ...
  \fig{figs/fig-8420596f.png}{Figure 14. The bridge admittances associated with 
  Sounds G.8 (blue curve), G.10 (red curve) and G.13 (black curve).} 
  ...
  \samsection{H. The effect of the 3 kHz bridge hill} 
  ...
  \fig{figs/fig-a19cba6a.png}{Figure 15. The bridge admittances associated with 
  Sounds H.1 (blue curve), H.4 (red curve) and H.5 (black curve).} 
  ...
  \samsection{I. ``Zinginess'' and the damping question} 
  ...
  \samsection{Postscript: experiments with different bridges} 
