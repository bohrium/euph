  ...
  \fig{figs/fig-2ff72db7.png}{\caption{Figure 3. The impulse response 
  corresponding to the clarinet impedance shown in Fig. 1, computed from the 
  fitted modal parameters.}} 

  \fig{figs/fig-c4746eeb.png}{\caption{Figure 4. The impulse response 
  corresponding to the saxophone impedance shown in Fig. 2, computed from the 
  fitted modal parameters.}} 
  ...
  \fig{figs/fig-7b9953b8.png}{\caption{Figure 5. The modal frequencies for the 
  clarinet (red curve) and the soprano saxophone (blue curve) deduced from 
  modal fitting, each normalised by the fundamental frequency. The ``error 
  bars'' indicate the half-power bandwidths of each modal peak. The lower green 
  line shows the behaviour expected if the frequencies were perfectly harmonic 
  with ratios 1,2,3,4... while the upper green line shows the corresponding 
  behaviour for frequency ratios 1,3,5,7... The dashed black curve shows the 
  values used in the idealised clarinet model from section 11.3, and the dotted 
  black curve shows the corresponding idealised saxophone model.}} 
  ...
  \fig{figs/fig-24e29975.png}{\caption{Figure 6. The Q-factors deduced from the 
  modal fitting process, for the clarinet (red) and the soprano saxophone 
  (blue). The dashed black curve shows corresponding Q-factors deduced from the 
  idealised clarinet impedance, shown in Fig. 1 of section 11.3.2 and used for 
  the clarinet simulations of section 11.3. The dotted black curve shows the 
  corresponding idealised saxophone model from section 11.3.3.}} 
  ...
  \fig{figs/fig-87894312.png}{\caption{Figure 7. The amplitude factors (squared 
  modal amplitudes) deduced from the modal fitting process, for the clarinet 
  (red) and the soprano saxophone (blue). The dashed black curve shows the 
  values used in the idealised clarinet model from section 11.3, and the dotted 
  black curve shows the corresponding idealised saxophone model.}} 
  ...
  \fig{figs/fig-7107cfd9.png}{\caption{Figure 8. Example transient of the 
  clarinet model: the upper curve shows the mouthpiece pressure, the lower 
  curve shows the volume flow rate into the mouthpiece. This is a ``cold 
  start'' transient: it corresponds to the bottom right-hand pixel in Fig. 9. 
  <meta http-equiv="content-type" content="text/html; charset=utf-8">[Modal 
  clarinet model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-fc37e1d1.png}{\caption{Figure 9. Pressure-gap diagram for the 
  clarinet over the same ranges of mouth pressure and reed gap as the examples 
  shown in section 11.3. These simulations were all run assuming a ``cold 
  start'', with the mouth pressure suddenly applied at time $t=0$. The colour, 
  uniformly red, shows that whenever there was a note rather than silence, it 
  had a period matching (approximately) the fundamental frequency of the tube, 
  i.e. the first register of the clarinet. The assumed Q-factor of the reed was 
  2.5, as in Fig. 32 of section 11.3. The various sloping lines indicate 
  thresholds of various kinds, exactly as discussed in section 11.3. <meta 
  http-equiv="content-type" content="text/html; charset=utf-8">[Modal clarinet 
  model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-341004b2.png}{\caption{Figure 10. Pressure-gap diagram as in 
  Fig. 9, but initialised in a way that encouraged oscillation at the 
  fundamental frequency. The resulting red wedge indicates the region in this 
  plane in which it is possible to maintain a steady note in the first 
  register, once it is started. The three horizontal green lines mark the sets 
  of waveforms to be shown in Fig. 13. <meta http-equiv="content-type" 
  content="text/html; charset=utf-8">[Modal clarinet model using measured 
  impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-4204fbf3.png}{\caption{Figure 11. Pressure-gap diagram for the 
  same simulations as in Fig. 10, but now colour-shaded to show the pitch 
  deviation in cents from the nominal pitch of this note ($D\_3$, 146.8~Hz). 
  <meta http-equiv="content-type" content="text/html; charset=utf-8">[Modal 
  clarinet model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-a28340af.png}{\caption{Figure 12. Pressure-gap diagram for the 
  same simulations as in Fig. 10, but now colour-shaded to indicate the 
  frequency content of the final waveform by the value of the highest harmonic 
  that remains close to the level predicted by the Raman square wave. This 
  diagram is in the same format as Fig. 17 and later plots from section 11.3. 
  <meta http-equiv="content-type" content="text/html; charset=utf-8">[Modal 
  clarinet model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-b2c96999.png}{\caption{Figure 13. The final portion of the 
  waveforms along lines marked in green in Fig. 10, for the cases that produced 
  notes. The left-hand column corresponds to the upper line, the middle column 
  to the middle line, the right-hand column to the lower line. Left-to-right 
  rows in Fig. 10 become top-to-bottom stacks here, so that mouth pressure 
  increases as you move down each column. <meta http-equiv="content-type" 
  content="text/html; charset=utf-8">[Modal clarinet model using measured 
  impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-def109a2.png}{\caption{Figure 14. Pressure-gap diagram matching 
  Fig. 9, but taken over a wider range of mouth pressure and reed gap. A few 
  white pixels indicate conditions that led to over-blowing to the second 
  register (with a frequency close to the second mode of the pipe, 
  approximately 3 times the fundamental frequency, a musical twelfth). <meta 
  http-equiv="content-type" content="text/html; charset=utf-8">[Modal clarinet 
  model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-25f4933c.png}{\caption{Figure 15. Pressure-gap diagram over the 
  same ranges as Fig. 14, but for transient conditions matching Fig. 10. <meta 
  http-equiv="content-type" content="text/html; charset=utf-8">[Modal clarinet 
  model using measured impedance, dynamic reed model.]}} 

  \fig{figs/fig-372d6e61.png}{\caption{Figure 16. Pressure-gap diagram 
  corresponding to Fig. 15, except that the oscillation was initialised to 
  encourage the second register rather than the first register. <meta 
  http-equiv="content-type" content="text/html; charset=utf-8">[Modal clarinet 
  model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-df0d41b5.png}{\caption{Figure 17. The waveform of pressure for 
  a successful transient of the saxophone model. <meta 
  http-equiv="content-type" content="text/html; charset=utf-8">[Modal saxophone 
  model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-79a099d6.png}{\caption{Figure 18. Pressure-gap diagram for the 
  saxophone over the same ranges of mouth pressure and reed gap as the examples 
  shown in section 11.3. These simulations were all run assuming a ``cold 
  start'', with the mouth pressure suddenly applied at time $t=0$. The colour 
  indicates which register of the saxophone each note plays in. The assumed 
  Q-factor of the reed was 2.5. The three horizontal green lines mark the sets 
  of waveforms to be shown in Fig. 18, and the circles mark cases whose 
  frequency spectra are shown in Fig. 20. [Modal saxophone model using measured 
  impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-4ae784bb.png}{\caption{Figure 19. The final portion of the 
  waveforms along lines marked in green in Fig. 18, for the cases that produced 
  notes. The left-hand column corresponds to the upper line, the middle column 
  to the middle line, the right-hand column to the lower line: the format is 
  the same as Fig. 13. The second waveform from the top in the middle column is 
  the case shown in Fig. 17. [Modal saxophone model using measured impedance, 
  dynamic reed model.]}} 
  ...
  \fig{figs/fig-27d82b74.png}{\caption{Figure 20. Frequency spectra of the 
  steady waveforms of runs marked by circles in Fig. 18. In the interests of 
  clarity, the spectra have been separated by steps of 40~dB. [Modal saxophone 
  model using measured impedance, dynamic reed model.]}} 
  ...
  \aud{auds/aud-abee1eea-plot.png}{\caption{Sound 1. The simulations from the 
  bottom row of Fig. 18, or the right-hand column of Fig. 19, strung together 
  so you can hear the regime transitions.}} 
  ...
  \fig{figs/fig-e670e301.png}{\caption{Figure 21. Pressure-gap diagram for the 
  same simulations as in Fig. 18, but now colour-shaded to show the pitch 
  deviation in cents from the nominal frequency, taking the different registers 
  into account. [Modal saxophone model using measured impedance, dynamic reed 
  model.]}} 
  ...
  \fig{figs/fig-af7911eb.png}{\caption{Figure 22. Pressure-gap diagram as in 
  Fig. 18, but initialised in a way that encouraged oscillation at the 
  fundamental frequency. The resulting red wedge indicates the region in this 
  plane in which it is possible to maintain a steady note in the first 
  register, once it is started. The three horizontal green lines mark the sets 
  of waveforms to be shown in Fig. 25. [Modal saxophone model using measured 
  impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-1d8d72f3.png}{\caption{Figure 23. Pressure-gap diagram for the 
  same simulations as in Fig. 22, but now colour-shaded to show the deviation 
  in cents from the nominal frequency. [Modal saxophone model using measured 
  impedance, dynamic reed model.]}} 

  \fig{figs/fig-b4e936b1.png}{\caption{Figure 24. Pressure-gap diagram for the 
  same simulations as in Fig. 22, but now colour-shaded to show the spectral 
  centroid of the final periodic waveform. [Modal saxophone model using 
  measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-2f28a513.png}{\caption{Figure 25. The final portion of the 
  waveforms along lines marked in green in Fig. 22, for the cases that produced 
  notes. The left-hand column corresponds to the upper line, the middle column 
  to the middle line, the right-hand column to the lower line: the format is 
  the same as Fig. 13. [Modal saxophone model using measured impedance, dynamic 
  reed model.]}} 
  ...
  \fig{figs/fig-86665834.png}{\caption{Figure 27. Pressure-gap diagram computed 
  with the multiphonic fingering giving the impedance in Fig. 26. The three 
  circles mark the cases used in Figs. 28 and 29, and in Sound 2. [Modal 
  clarinet model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-555b5b21.png}{\caption{Figure 28. The pressure waveforms from 
  pixels 30, 28 and 26 in the bottom row if Fig. 27 (marked there by circles). 
  [Modal clarinet model using measured impedance, dynamic reed model.]}} 
  ...
  \fig{figs/fig-32a55546.png}{\caption{Figure 29. Frequency spectra of the 
  three waveforms shown in Fig. 28, calculated from the next half-second of the 
  signals after the portion shown in the plot. [Modal clarinet model using 
  measured impedance, dynamic reed model.]}} 

  \aud{auds/aud-fb9330fd-plot.png}{\caption{Sound 2. Sound demonstration of the 
  three pressure waveforms shown in Fig. 28.}} 
