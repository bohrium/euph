...
\moobeginvid\begin{tabular}{ccc} \vidframe{ 0.30 }{ vids/vid-37441170-00.png }&\vidframe{ 0.30 }{ vids/vid-37441170-01.png }&\vidframe{ 0.30 }{ vids/vid-37441170-02.png } \end{tabular}\caption{Figure 4. A mode shape of a violin body. Data and animation copyright George Stoppani, reproduced by permission.}\mooendvideo
  ...
  \aud{auds/aud-fa6a91e5-plot.png}{\caption{Sound 1. The sound of the toy drum, 
  corresponding to the spectrogram in Fig. 5.}} 
  ...
  \aud{auds/aud-cae472f6-plot.png}{\caption{Sound 2. The sound of a plucked 
  guitar string, corresponding to the spectrogram in Fig. 6.}} 

  \fig{figs/fig-8a6ceb14.png}{\caption{Figure 7: A spectrogram of a note on a 
  violin, played with vibrato}} 

  \aud{auds/aud-973d6889-plot.png}{\caption{Sound 3. The sound of a violin note 
  with vibrato, corresponding to the spectrogram in Fig. 7.}} 
  ...
  \aud{auds/aud-e550269d-plot.png}{\caption{Sound 4. The sound of the tamtam, 
  corresponding to the spectrogram in Fig. 8.}} 
