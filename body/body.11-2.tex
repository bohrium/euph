  ...
  \fig{figs/fig-2dd6d52f.png}{\caption{Figure 1. A small waterfall illustrates 
  the contrast between laminar flow (over the lip of the fall and during the 
  ...
  \fig{figs/fig-84f2f746.png}{\caption{Figure 2. A schlieren image of the plume 
  rising from a candle flame. The flow is laminar in the lower half of the 
  image, but exhibits a spontaneous transition to turbulence higher up. Image: 
  Gary Settles, CC BY-SA 3.0 (https://creativecommons.org/licenses/by-sa/3.0), 
  ...
  \fig{figs/fig-d45a563f.png}{\caption{Figure 3. Honey running slowly off a 
  spoon, to illustrate the concept of viscosity.}} 
  ...
  \fig{figs/fig-7f24e0eb.png}{\caption{Figure 4. Illustration of shear 
  deformation of a layer of fluid between two rigid plates}} 
  ...
  \fig{figs/fig-717bbebb.png}{\caption{Figure 5. Tipping water out of a spoon: 
  sketch, and closeup showing the formation of a very thin boundary layer 
  against the surface of the spoon. The thin black lines and red arrows show 
  ...
  \fig{figs/fig-96d85249.png}{\caption{Figure 6. Flow visualisation from a wind 
  tunnel, showing an airfoil wing section. The boundary layer on the upper 
  surface separates, and gives rise to a wake structure. Image: DLR, CC-BY 3.0, 
  CC BY 3.0 DE https://creativecommons.org/licenses/by/3.0/de/deed.en, via 
  Wikimedia Commons}} 
  ...
  \fig{figs/fig-7b1e3156.png}{\caption{Figure 7. A Kármán vortex street, 
  generated by flow past a cylindrical body. The boundary layer separation 
  point oscillates, shedding vortices in alternating directions. Image: Jürgen 
  Wagner -- Self-photographed, CC BY-SA 4.0, 
  ...
  \fig{figs/fig-42960824.png}{\caption{Figure 8. Schlieren image of a wide 
  air-jet entering from a slot (the end of it is visible on the left), 
  interacting with a sharp edge in the upper right of the picture. It shows 
  unstable vortex growth of the shear layers on either side of the jet. Image 
  copyright Sylvie Dequand, reproduced by permission.}} 
