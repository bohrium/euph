  ...
  \fig{figs/fig-e64ea4b7.png}{Figure 1. Sketch of the upper lip of a brass 
  player, showing the two components of motion} 
  ...
  \fig{figs/fig-62405eef.png}{Figure 2. A pressure --- lip resonance diagram 
  for a trombone for the same model as Fig. 22 of section 11.5, for the case in 
  which the Q factor of the lip resonance is 7. The colour shading indicates 
  the transient length before a periodic motion is established, and the green 
  box shows the region to be studied in detail in this section.} 
  ...
  \fig{figs/fig-60f95027.png}{Figure 3. Set of pressure --- lip resonance 
  diagrams, covering the range indicated by the green box in Fig. 1. The Q 
  factor of the lip resonance is 7, $L_{lip}$ is 1~mm , $\alpha=2$ and 
  ...
  \fig{figs/fig-0ab6c20b.png}{Figure 4. Set of pressure --- lip resonance 
  diagrams for the same parameter values as Fig. 3, except that now $L_{lip}$ 
  is 8~mm. The format and colour shading is the same as in Fig. 3.} 

  \fig{figs/fig-025051ed.png}{Figure 5. Set of pressure --- lip resonance 
  diagrams for the same parameter values as Figs. 3 and 4, except that now 
  $L_{lip}$ is 8~mm and $\lambda=2$. The format and colour shading is the same 
  as in Fig. 3.} 
  ...
  \fig{figs/fig-175bebde.png}{Figure 6. Set of pressure --- lip resonance 
  diagrams for a model with $Q=5$, $L_{lip}=8$mm and $\lambda=0$. Colour 
  shading now indicates the phase lag of $y$ behind $x$, in degrees. The 
  ...
  \fig{figs/fig-6687b27d.png}{Figure 7. Set of pressure --- lip resonance 
  diagrams for the same model as Fig. 6, with $Q=5$, $L_{lip}=8$mm and 
  $\lambda=0$. Colour shading now indicates the deviation of the playing 
  ...
  \fig{figs/fig-dd35ac53.png}{Figure 8. Set of pressure --- lip resonance 
  diagrams for the same model as Fig. 6, with $Q=5$, $L_{lip}=8$mm and 
  $\lambda=0$. Colour shading now indicates a measure of the net deviation of 
  phase between the simulations and the measured waveforms of Boutin et al. [1] 
  for their ``lipped down'' case, the left-hand column of their Fig. 3. The 
  coloured circle indicates the case that will be shown in Fig. 11.} 

  \fig{figs/fig-c0257793.png}{Figure 9. Set of pressure --- lip resonance 
  diagrams for the same model as Fig. 6, with $Q=5$, $L_{lip}=8$mm and 
  $\lambda=0$. Colour shading now indicates a measure of the net deviation of 
  phase between the simulations and the measured waveforms of Boutin et al. [1] 
  for their ``normal'' case, the middle column of their Fig. 3. The coloured 
  circle indicates the case that will be shown in Fig. 12.} 

  \fig{figs/fig-020fe328.png}{Figure 10. Set of pressure --- lip resonance 
  diagrams for the same model as Fig. 6, with $Q=5$, $L_{lip}=8$mm and 
  $\lambda=0$. Colour shading now indicates a measure of the net deviation of 
  phase between the simulations and the measured waveforms of Boutin et al. [1] 
  for their ``lipped up'' case, the right-hand column of their Fig. 3. The 
  ...
  \fig{figs/fig-c85b71f0.png}{Figure 11. Simulated waveforms for the case 
  marked by a green circle in Fig. 8, compared with corresponding waveforms 
  measured by Boutin et al. [1] for their case in which the note was ``lipped 
  down''. All simulated waveforms are shown as solid lines, while measured ones 
  are shown as dashed lines in the corresponding colour. The top plot shows the 
  comparison for the pressure inside the mouthpiece. The middle plot shows the 
  total volume flow rate (blue) and the sweeping flow contribution to that 
  (green). The bottom plot shows the lip opening area.} 

  \fig{figs/fig-340afc3f.png}{Figure 12. Simulated waveforms for the case 
  marked by a green circle in Fig. 9, compared with corresponding waveforms 
  measured by Boutin et al. [1] for their case in which the note was played 
  normally. All simulated waveforms are shown as solid lines, while measured 
  ones are shown as dashed lines in the corresponding colour. The top plot 
  shows the comparison for the pressure inside the mouthpiece. The middle plot 
  shows the total volume flow rate (blue) and the sweeping flow contribution to 
  that (green). The bottom plot shows the lip opening area.} 

  \fig{figs/fig-ab950a30.png}{Figure 13. Simulated waveforms for the case 
  marked by a green circle in Fig. 10, compared with corresponding waveforms 
  measured by Boutin et al. [1] for their case in which the note was ``lipped 
  up''. All simulated waveforms are shown as solid lines, while measured ones 
  are shown as dashed lines in the corresponding colour. The top plot shows the 
  comparison for the pressure inside the mouthpiece. The middle plot shows the 
  total volume flow rate (blue) and the sweeping flow contribution to that 
  (green). The bottom plot shows the lip opening area.} 
